/*
  ...
  - You are about to drop the column `firstTeamCountCode` on the `Game` table. All the data in the column will be lost.
  - You are about to drop the column `secondTeamCountCode` on the `Game` table. All the data in the column will be lost.
